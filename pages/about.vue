<template>
  <div class="about" :class="{ mobile: mobileLayout }">
    ...
    <div class="info-box" :class="{ 'info-mobile': mobileLayout }">
      <div class="info">
        <div class="list">
          ...
          <span class="list-content">Nolan, <span>a 95s boy.</span></span>
        </div>
        <div class="list">
        ...
        <div class="list">
          ...
          <span class="list-content icons">
            <a href="https://github.com/luciferclc" target="_blank"
              ><i class="iconfont icon-github"></i
            ></a>
            <a
              href="https://juejin.im/user/5858c896128fe1006b86cb51"
              target="_blank"
              ><i class="iconfont icon-juejin"></i
            ></a>
            <a
              href="https://weibo.com/5329847417/profile?rightmod=1&wvr=6&mod=personinfo"
              target="_blank"
              ><i class="iconfont icon-weibo"></i
            ></a>
            <a href="" target="_blank"><i class="iconfont icon-twitter"></i></a>
            <a
              href="https://segmentfault.com/u/sanmao_58e1f28560e06"
              target="_blank"
            ...
            <a href="mailto:luciferclc@foxmail.com" target="_blank"
    ...
    <div class="text-box">
      <div class="text">
        <div class="left">
          ...
          <p>
            Have so many new ideas, <br v-if="mobileLayout" />maybe i will go to
            relize it
          </p>
    ...
    <appreciate :mobile-layout="mobileLayout"></appreciate>

    <book :mobile-layout="mobileLayout"></book>
    ...
    <div class="last">
      ...
      <p>
        ...
        <i
          ><a
            href="https://jkchao.cn/article/5a03f6ec0a7b41779c672afa"
            target="_blank"
            >来，喝酒吧！</a
          ></i
        >这都是我乱说的。
