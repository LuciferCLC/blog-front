<template>
  <div class="article-list" :class="{'mobile': mobileLayout}">
    <div class="article-cont">
      ...
      <progressive-image :thumb="article.thumb" v-if="article.thumb" />
    ...
    <div class="comment">
      <comments :post-id="article.id" v-if="article.title" />
    </div>
    <aside v-if="!mobileLayout">
      <div
        ...
        :class="{'is-liked': isLiked}"
      >
        <i class="iconfont icon-like like" :class="{ 'rubberBand': isLiked }" />
        <div
  ...
  methods: {
    ...
    initEvent () {
      ...
      content.addEventListener('click', (e) => {
        ...
        if (target.nodeName.toLocaleLowerCase() === 'img' && target.classList.contains('image-large')) {
          e.stopPropagation()
